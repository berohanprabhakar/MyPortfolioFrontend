...
function ExperienceTab({ exp, expand }: any) {
  ...
  return (
    <div onClick={() => setExpanded(!expanded)} className="hover:shadow-md cursor-pointer bg-white shadow rounded-lg p-6 transition-all duration-300 flex items-start gap-6">
      {/* Logo Section */}

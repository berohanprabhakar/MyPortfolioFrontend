  ...
  return (
    <main className="pt-20 max-w-4xl mx-auto">
      <div className="bg-white shadow rounded-lg p-6 space-y-4">
        ...
        <p>
          LinkedIn:{' '}
          <a href="https://linkedin.com/in/rohan--prabhakar" target="_blank" className="text-blue-600">
            linkedin.com/in/rohan--prabhakar
          </a>
        </p>
        <p>
          GitHub:{' '}
          <a href="https://github.com/berohanprabhakar" target="_blank" className="text-blue-600">
